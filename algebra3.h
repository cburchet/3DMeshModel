...
friend vec3 minv(const vec3& a, const vec3& b);		    // min(v1, v2)
friend vec3 maxv(const vec3& a, const vec3& b);		    // max(v1, v2)
...
friend vec4 minv(const vec4& a, const vec4& b);		    // min(v1, v2)
friend vec4 maxv(const vec4& a, const vec4& b);		    // max(v1, v2)
